...
class DishesController {
   ...
   async getDishes(req, res) {
      ...
      const dishes = await db.query(
         ...
         ORDER BY MAX(Dishes_Ingredients.created_at_DI) DESC;`)
   ...
   async getOrders(req, res) {
      ...
      GROUP BY o.id, o.dish_title, created_at
      ORDER BY o.id;`)
   ...
   async addOrder(req, res) {
      try {
         ...
         const dishResult = await db.query('INSERT INTO Dishes (title) VALUES ($1) RETURNING id', [dish_title]);
